  ...
  return (
    <div className="flex items-center gap-2 justify-center my-4">
        ...
        <button
          ...
          className={`px-3 py-1 rounded-md border ${
            p === currentPage
              ...
              : "bg-gray-800 border-neutral-700 hover:bg-neutral-700"
          }`}
        >
          {p}
        </button>
      ...
      <button
        ...
        className="px-3 py-1 rounded-md border bg-gray-800 border-neutral-700 hover:bg-neutral-700 disabled:opacity-50"
      >
        Next
      </button>
    </div>
